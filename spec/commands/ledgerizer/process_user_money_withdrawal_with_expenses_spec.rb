...
describe Ledgerizer::ProcessUserMoneyWithdrawalWithExpenses do
  ...
  let(:expected_entry) do
    {
      entry_code: :money_withdrawal_with_expenses,
      entry_time: now,
  ...
  context "with valid data" do
    ...
    let(:expected_amount_2) do
      Money.from_amount((invested_amount - extra_amount).round(2), currency)
    end
