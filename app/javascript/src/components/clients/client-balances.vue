  ...
  <div>
    ...
    <div>
      <relation-title-bar
        class="mb-6"
        :is-demo="isDemo"
        :title="$t('message.titles.investmentsSummary')"
      />
      <div class="flex flex-col w-full lg:border-t lg:border-gray-300 lg:block">
        ...
        <div class="flex flex-col items-center justify-center mb-4 lg:justify-between lg:flex-row">
          <info-text
            ...
            :title="$t('message.clientBalances.consolidatedCapital.name')"
            ...
            <div class="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
              ...
              >
                <time-selector
                  ...
                  :info-chart="$t('message.clientBalances.chart.info')"
                />
                <info-tooltip
                  v-if="isUser"
                  @click="updateChart"
...
export default {
  ...
  mounted() {
    this.$store.dispatch('getLastUpdatedDate', this.lastUpdated);
  }
};
</script>
