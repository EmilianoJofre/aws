class Ledgerizer::ExecuteRevertWithdrawal < PowerTypes::Command.new(
  :user,
  :money_movement
)
  ...
  def withdrawal_type
    ...
    if sale_price < average_price
      Ledgerizer::RevertUserMoneyWithdrawalWithExpenses
    elsif sale_price > average_price
      Ledgerizer::RevertUserMoneyWithdrawalWithIncomes
    elsif sale_price == average_price
      Ledgerizer::ProcessUserMoneyInvestment
    end
  end
end
